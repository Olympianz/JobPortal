...
/**
 * Remote interface for simple/SimpleCMP.
 * @xdoclet-generated at 05-mars-02 22:51:01
 */
public interface SimpleCMP
   extends javax.ejb.EJBObject
{
    ...
    */
   public byte getAByte(  ) throws java.rmi.RemoteException;
    ...
    */
   public char getAChar(  ) throws java.rmi.RemoteException;
    ...
    */
   public double getADouble(  ) throws java.rmi.RemoteException;
    ...
    */
   public float getAFloat(  ) throws java.rmi.RemoteException;
    ...
    */
   public long getALong(  ) throws java.rmi.RemoteException;
    ...
    */
   public short getAShort(  ) throws java.rmi.RemoteException;
    ...
    */
   public int getAnInt(  ) throws java.rmi.RemoteException;
    ...
    */
   public Object getAnObject(  ) throws java.rmi.RemoteException;
    ...
    */
   public Object[] getAnObjectArray(  ) throws java.rmi.RemoteException;
    ...
    */
   public boolean isABoolean(  ) throws java.rmi.RemoteException;

   /**
    * Set the value of aBoolean
    * @param aBoolean  Value to assign to aBoolean
    */
   public void setABoolean( boolean aBoolean ) throws java.rmi.RemoteException;

   /**
    * Set the value of aByte
    * @param aByte  Value to assign to aByte
    */
   public void setAByte( byte aByte ) throws java.rmi.RemoteException;

   /**
    * Set the value of aChar
    * @param aChar  Value to assign to aChar
    */
   public void setAChar( char aChar ) throws java.rmi.RemoteException;

   /**
    * Set the value of aDouble
    * @param aDouble  Value to assign to aDouble
    */
   public void setADouble( double aDouble ) throws java.rmi.RemoteException;

   /**
    * Set the value of aFloat
    * @param aFloat  Value to assign to aFloat
    */
   public void setAFloat( float aFloat ) throws java.rmi.RemoteException;

   /**
    * Set the value of aLong
    * @param aLong  Value to assign to aLong
    */
   public void setALong( long aLong ) throws java.rmi.RemoteException;

   /**
    * Set the value of aShort
    * @param aShort  Value to assign to aShort
    */
   public void setAShort( short aShort ) throws java.rmi.RemoteException;

   /**
    * Set the value of anInt
    * @param anInt  Value to assign to anInt
    */
   public void setAnInt( int anInt ) throws java.rmi.RemoteException;

   /**
    * Set the value of anObject
    * @param anObject  Value to assign to anObject
    */
   public void setAnObject( Object anObject ) throws java.rmi.RemoteException;

   /**
    * Set the value of anObjectArray
    * @param anObjectArray  Value to assign to anObjectArray
    */
   public void setAnObjectArray( Object[] anObjectArray ) throws java.rmi.RemoteException;
